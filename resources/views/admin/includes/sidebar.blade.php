    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-home"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">{{__('لغات الموقع')}} </span>
                    <span
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li>
                        <a class="menu-item" href="#" data-i18n="nav.templates.vert.main">{{__('admin/sidebar.ShippingMethod')}}</a>
                        <ul class="menu-content">
                            <li>
                                <a class="menu-item" href="{{route('edit.shipping.method', 'free')}}"
                                   data-i18n="nav.templates.vert.classic_menu">{{__('admin/sidebar.freeShipping')}}</a>
                            </li>
                            <li>
                                <a class="menu-item" href="{{route('edit.shipping.method', 'outer')}}">
                                    {{__('admin/sidebar.outerShipping')}}</a>
                            </li>
                            <li>
                                <a class="menu-item" href="{{route('edit.shipping.method', 'inner')}}"
