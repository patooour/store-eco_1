        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">{{__("admin/header.hello")}}
                  ...
                  <img  style="height: 35px;" src="{{auth('admin')->user()->image}}" alt="{{auth('admin')->user()->name}}"><i></i></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item"
                                                                          href="{{route('admin.edit.profile')}}"><i
                                    class="ft-user"></i> {{__("admin/header.edit profile")}} </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{route('admin.logout')}}">
                                <i class="ft-power"></i>{{__("admin/header.logout")}} </a>
                        </div>
                    </li>
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
