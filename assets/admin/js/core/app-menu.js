...
(function(window, document, $) {
  ...
  $.app.menu = {
    ...
    change: function(defMenu) {
      ...
      // Initialize drill down menu for vertical includes, for horizontal includes drilldown menu is intitialized in changemenu function
    ...
    changeMenu: function(screen){
      ...
      if(screen == 'sm' || screen == 'xs'){
        ...
        // Intitialize drill down menu for horizontal includes
        // --------------------------------------------------
